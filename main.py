...
attribute_constraints = [
    ...
    },
    {
        ...
        type : categorical,
        category : financial_cat,
        values : ['paid back all previous loans', 'no problem with current loans', 'paid back all previous loans at this bank', 'delay payment of previous loans'],
    ...
    },
    {
        ...
        type : categorical,
        category : loan_cat,
        values : ['furniture', 'television', 'used car', 'domestic appliances', 'repairs', 'education', 'retraining', 'business', 'new car', 'other'],
    ...
    },
    {
        ...
        type : categorical,
        category : financial_cat,
        values : ['no additional loans', 'at other banks', 'at department store'],
    ...
    },
    {
        ...
        type : categorical,
        category : personal_cat,
        values : ['executive or self-employed', 'unskilled (non-resident)', 'unskilled (permanent resident)', 'skilled'],
